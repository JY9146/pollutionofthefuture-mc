...
import net.mcreator.pollution.fluid.OilFluid;
import net.mcreator.pollution.PollutionModMod;

public class PollutionModModFluids {
	public static final DeferredRegister<Fluid> REGISTRY = DeferredRegister.create(ForgeRegistries.FLUIDS, PollutionModMod.MODID);
