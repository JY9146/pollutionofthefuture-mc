...
public class PollutedCloudsProcedure {
	...
	private static void buildClouds(CloudStatus cloudStatus, double x, double y, double z) {
		if (cloudBuffer == null || PollutedCloudsProcedure.cloudStatus != cloudStatus || PollutedCloudsProcedure.x != x || PollutedCloudsProcedure.y != y || PollutedCloudsProcedure.z != z) {
			PollutedCloudsProcedure.cloudStatus = cloudStatus;
			PollutedCloudsProcedure.x = x;
			PollutedCloudsProcedure.y = y;
			PollutedCloudsProcedure.z = z;
			Minecraft minecraft = Minecraft.getInstance();
